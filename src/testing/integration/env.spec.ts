...
describe('env', () => {
  ...
  it('should pass env to docker', async () => {
    const testCase = await suite.setup()
    const result = await testCase.exec('example_docker')
    await expectSuccessfulResult(result)
  ...
  it('should use env from task', async () => {
    const testCase = await suite.setup()
    const result = await testCase.exec('example_override')
    await expectSuccessfulResult(result)
  ...
  it('should use env from .env', async () => {
    const testCase = await suite.setup()
    const result = await testCase.exec('example_with_dotenv')
    await expectSuccessfulResult(result)
  ...
  it('should use process env', async () => {
    ...
    const result = await testCase.exec('example_with_shell_env')
    await expectSuccessfulResult(result)
