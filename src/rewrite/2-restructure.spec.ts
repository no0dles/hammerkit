...
describe('restructure', () => {
  ...
  it('should resolve dependencies', () => {
    ...
    expect(tree['/home/user/pkg/b:build'].dependencies).toIncludeAllMembers(['/home/user/pkg/b:npm:install', '/home/user/pkg/a:build', '/home/user/pkg/a:npm:install']);
    expect(tree['/home/user/pkg/c:build'].dependencies).toIncludeAllMembers(['/home/user/pkg/a:npm:install', '/home/user/pkg/b:npm:install', '/home/user/pkg/c:npm:install', '/home/user/pkg/a:build', '/home/user/pkg/b:build']);
  });
